...
// Base URL for absolute image paths (replace with your actual domain)
const BASE_URL = "https://nutri-guide-delta.vercel.app";
...
const Home = () => {
  ...
  return (
    <div className="flex flex-col items-center bg-white overflow-hidden">
      {/* Fixed SEO Section */}
      <Helmet>
        <title>NutriGuide | AI Nutrition & Health Tips</title>
        <meta
          name="description"
          content="Get smart AI-based diet and fitness tips tailored to your health goals. Free, easy, and effective!"
        />
        <meta
          name="keywords"
          content="nutrition, health, AI diet planner, fat loss, wellness"
        />
        <meta name="author" content="Harshad Dongardive" />
        <link rel="canonical" href={BASE_URL} />

        {/* Open Graph for WhatsApp/Facebook */}
        <meta property="og:title" content="NutriGuide – AI Nutrition Planner" />
        <meta
          property="og:description"
          content="Smart food and health recommendations for your condition."
        />
        <meta property="og:image" content={`${BASE_URL}/healthy1.jpg`} />
        ...
        <meta
          name="twitter:title"
          content="NutriGuide – AI Nutrition Planner"
        />
        <meta
          name="twitter:description"
          content="Smart food and health recommendations for your condition."
        />
        <meta name="twitter:image" content={`${BASE_URL}/healthy1.jpg`} />
      </Helmet>
      ...
      <section className="w-10/12  p-4 ">
        <div className="lg:grid lg:grid-flow-row-dense lg:grid-cols-2 lg:gap-12 lg:items-center">
          <div className="lg:col-start-2 md:pl-20">
            <h4 className="text-4xl font-bold leading-8 tracking-tight text-gray-900 dark:text-white sm:leading-9">
              How It Works
            </h4>
            <ul className="mt-10">
              <li>
          ...
          <div className="relative space-y-4 overflow-hidden ml-10 ">
            <div className="flex items-end justify-center ml-8 space-x-4 lg:justify-start">
              <img
                className="w-30 object-cover rounded-lg shadow-lg md:w-56"
                width="200"
              ...
              />
              <img
                className="w-40 h-full object-cover rounded-lg shadow-lg md:w-64"
                width="260"
            ...
            <div className="flex items-start justify-center ml-32 space-x-4 lg:justify-start">
              <img
                className="w-24 object-cover rounded-lg shadow-lg md:w-40"
                width="170"
                src="https://images.unsplash.com/photo-1511690743698-d9d85f2fbf38?q=80&w=1887&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                alt="Fresh ingredients"
              />
              <img
                className="w-32 object-cover rounded-lg shadow-lg md:w-56"
                width="200"
...
//         />
//         <meta name="author" content="Harshad Dongardive" />
//         <link rel="canonical" href="https://nutri-guide-delta.vercel.app/" />
...
//         <meta
//           property="og:image"
//           content="https://nutri-guide-delta.vercel.app/"
//         />
...
//         <title>Nutriguide: Complete Health Guide</title>
//         <meta name="description" content="This is the site which tells you what todo and how to do ">
//         <meta name="author" content="Harshad Dongardive">
//         <meta name="copyright" content="HD PVT">
