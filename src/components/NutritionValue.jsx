...
//       }}
//     >
//       <div className="flex flex-col items-center bg-transparent p-4 rounded-xl max-w-4xl mx-auto">
//         <h2 className="text-2xl md:text-3xl p-4 font-extrabold text-yellow-300 mb-4 text-center">
//           Find Nutrition by Meal Name
//         </h2>
...
//             onChange={(e) => setMealName(e.target.value)}
//             placeholder="Enter meal name..."
//             className="w-full md:w-8/12 p-4 pl-12 border-0 rounded-full focus:outline-none focus:ring-2 focus:ring-blue-400 text-gray-900 mb-4 md:mb-0"
//           />
...
//         <button
//           onClick={handleSearch}
//           className="mt-4 relative inline-flex items-center justify-center p-0.5 mb-2 rounded-2xl overflow-hidden text-sm font-medium text-gray-900 bg-gradient-to-br from-purple-600 to-blue-500 hover:text-white focus:ring-4 focus:outline-none focus:ring-blue-300"
//         >
//           <span className="relative px-5 py-2.5 transition-all ease-in duration-75 bg-white rounded-2xl group-hover:bg-opacity-0">
//             Search
//           </span>
//         </button>
//         {loading && (
...
//       {nutritionData && (
//         <div className="w-full max-w-7xl mt-10 px-4 grid grid-cols-1 ">
//           {Object.entries(categorizeNutrients(nutritionData.nutrients)).map(
//             ([category, nutrients], index) => (
//               <div key={index} className="bg-white/60 p-4 rounded-xl shadow-md">
//                 <h3 className="text-xl md:text-2xl font-bold text-yellow-400 mb-4 text-center">
//                   {category}
//                 </h3>
//                 <div className="grid gap-4">
//                   {nutrients.map((nutrient, i) => (
//                     <div
//                       key={i}
//                       className="bg-purple-300 p-4 rounded-lg text-center shadow-lg"
//                     >
